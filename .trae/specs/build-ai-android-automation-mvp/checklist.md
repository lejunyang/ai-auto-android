...
- [ ] AccessibilityService 声明截图 capability，并在 API 30+ 可按需截图且对敏感内容和会话授权实施限制
- [ ] 会话截图开关会实际触发截图观察，并只向 Provider 发送用户授权的最小图像上下文
- [ ] 用户在 API 30-33 和 API 34+ 的目标 App 中触摸时会中止活动 AI 会话，且停止后不再提交动作
