...
export GOMODCACHE="$SDK_BASE/go-mod-cache"
...
export ANDROID_HOME="$SDK_BASE/android-sdk"
export ANDROID_SDK_ROOT="$ANDROID_HOME"
export ANDROID_USER_HOME="$SDK_BASE/android-cli-home/.android"
export ANDROID_EMULATOR_HOME="$ANDROID_USER_HOME"
export ANDROID_AVD_HOME="$SDK_BASE/android-avd"
export AACTL_EMULATOR_STATE="$SDK_BASE/emulator-state"
export AACTL_ANDROID_APK_CACHE="$SDK_BASE/android-apk-cache"
export AACTL_ADB_PATH="$ANDROID_HOME/platform-tools/adb"
